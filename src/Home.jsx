...
const styles = {
  masthead: {
    backgroundImage: process.env.NODE_ENV === 'production' ? 'url(static.superfeed.xyz/hero-bg-01.jpg)' : 'url(/hero-bg-01.jpg)',
  ...
  return <div>
    <div className='ui inverted vertical masthead center aligned segment' style={styles.masthead}>
      <div className='ui text container' style={styles.banner}>
        ...
        <h2 style={styles.h2}>Community-focused hyperlocal social media feed</h2>
        <br />
        <Login auto={false} />
      </div>
    </div>
